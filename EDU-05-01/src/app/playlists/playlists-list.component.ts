    ...
    <table class="table table-striped">
      ...
      <tbody>
        <tr *ngFor="let playlist of playlists; let i = index" class="playlist-row" 
          ...
          [ngStyle]="{ 
            backgroundColor: playlist.enter == true? '#009fe3' : '',
            'fontSize.%': playlist.enter == true? 130 : 100,
            color: playlist.enter == true? playlist.color : '',
            borderBottomColor: playlist.color
          }" 
          (mouseenter)="playlist.enter = true"
          (mouseleave)="playlist.enter = false"
